...
<div class="container">
		...
		<div class="row">
			<div class="card mb-3 col-12">
				<div class="card-body">
                    ...
                    <form action="/addAgendamentos" method="POST">
  ...
  <input type="text" class="form-control" placeHOLDER="(XX) XXXXX-XXXX" name="txtTelefone">
  </div>
...
<option value="Fixo">Telefone Fixo</option>
  ...
  <input type="date" class="form-control" name="dateContato">
  </div>
